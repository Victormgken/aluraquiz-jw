console.log('fazendo uma submit pelo react');import { delBasePath } from 'next/dist/next-server/lib/router/router';
    ...
    <QuizBackground backgroundImage={db.bg}>
      <QuizContainer>
        <Widget>
          ...
          <Widget.Content>
            <p>{db.questions[1].image}</p>
            <p>{db.questions[1].description}</p>
          </Widget.Content>
        </Widget>
        <Footer />
